...
static void scroll(VTermState *state, VTermRect rect, int downward, int rightward)
{
  ...
  if(state->scroll_callback) {
    state->scroll_callback(rect, downward, rightward, state->scroll_callback_userptr);
  }
...
void vterm_state_set_scroll_callback(VTermState* state,
        void(*callback)(VTermRect rect, int downward, int rightward, void *user), void* userptr) {
    state->scroll_callback = callback;
    state->scroll_callback_userptr = userptr;
}
